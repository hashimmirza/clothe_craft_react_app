...
function* authSaga({ type, payload }) {
  switch (type) {
    ...
    case SIGNUP:
      try {
        yield initRequest();
        const ref = yield call([firebase, firebase.createAccount], payload.email, payload.password);
        console.log("Saga firebase : ", ref)
        ...
        yield call([firebase, firebase.addUser], ref.user.uid, user);
